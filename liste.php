                ...
                <?php
                    foreach ($products as $product) {
                        ...
                        <div class="d-flex flex-row my-4">
                            ...
                            <div class="col-6 p-5">
                                <h3><?php if(isset($product_name)){echo preg_replace('#('.htmlspecialchars($_POST["product_name"]).')#i', '<span style="color: red;">$1</span>', $product['name']);} else { echo $product['name'];} ?></h3>
